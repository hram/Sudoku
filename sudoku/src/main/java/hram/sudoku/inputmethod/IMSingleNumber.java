...
public class IMSingleNumber extends InputMethod {
    ...
    private ImageButton mSwitchNumNoteButton, undoButton;
    ...
    public int getImageResource() {
        return R.drawable.single_number;
    }
    ...
    protected View createControlPanelView() {
        ...
        // отсканоровать новый судоку
        controlPanel.findViewById(R.id.capture_new).setOnClickListener(new OnClickListener() {
        ...
        // настройки
        controlPanel.findViewById(R.id.button_prop).setOnClickListener(new OnClickListener() {
        ...
        // очистить заметки
        controlPanel.findViewById(R.id.button_clear_noes).setOnClickListener(new OnClickListener() {
        ...
        // режим отображения
        controlPanel.findViewById(R.id.button_view_mode).setOnClickListener(new OnClickListener() {
        ...
        // назад
        undoButton = (ImageButton) controlPanel.findViewById(R.id.button_undo);
        undoButton.setEnabled(mGame.hasSomethingToUndo());
        ...
        // начать заново
        controlPanel.findViewById(R.id.button_restart).setOnClickListener(new OnClickListener() {
