...
import hram.sudoku.view.Sudoku.OnCellSelectedListener;
import hram.sudoku.view.Sudoku.OnCellTappedListener;
...
public class IMControlPanel extends LinearLayout {
    ...
    public void initialize(Sudoku board, SudokuGame game, HintsQueue hintsQueue) {
        mBoard = board;
    ...
    private void ensureControlPanel(int methodID) {
        ...
        if (!im.isInputMethodViewCreated()) {
            ...
            ImageButton switchModeButton = (ImageButton) controlPanel.findViewById(R.id.switch_input_mode);
